...
describe('createBuyOrder', () => {
    ...
    it('should always create an XPR_XUSDC buy order that is at least the order_min value', () => {
        for (let i = 0; i < 10; i += 1) {
            ...
            const order = currentStrategy.createBuyOrder(market.symbol, {
                highestBid: 0.3745,
                lowestAsk: 0.3925,
                market,
                price: 0.38,
...
describe('createSellOrder', () => {
    ...
    xit('should always create an XPR_XMD sell order that is at least the order_min value', () => {
        for (let i = 0; i < 10; i += 1) {
            const market = marketXprXmd;
            const order = currentStrategy.createSellOrder(market.symbol, {
                highestBid: 0.3745,
                lowestAsk: 0.3925,
                market,
                price: 0.38,
...
//# sourceMappingURL=marketmaker.test.js.map